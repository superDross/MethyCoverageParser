# Duncan S
# Script to read in bismark paired end SAM and parse to give BED of fragments
# For calculating read depth across features
...
print "Processing paired end file to BED: "+sys.argv[1]
