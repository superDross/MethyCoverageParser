...
if __name__ == '__main__':
    ...
    group.add_option('-b', '--create-basespace-directory-structure', help='recreate the basespace directory structure in the output directory', dest='createBsDir', action='store_false', default=True)
    parser.add_option_group(group)
